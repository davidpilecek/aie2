    ...
    if select_task == 2:
        ...
        if marker_ids is not None:
            ...
            try:
                ...
                # used for testing, comparing use of PID and non-PID values for movement
                ...
                if MARGIN_OF_ANGLE < yaw_combined < 90:
                    aligned_rotation = False
                    dfu.drift_left(speed_drift_pid, arduino_port)
                elif -90 < yaw_combined < -MARGIN_OF_ANGLE:
                    aligned_rotation = False
                    dfu.drift_right(speed_drift_pid, arduino_port)
                else:
                ...
                # if all aligned, stop all movement    
